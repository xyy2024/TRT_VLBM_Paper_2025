...
#    Test code for Numerical Experiment Section 02 (Poiseuille Flow) Fig 03
...
def test(h_list, nu, file_id, average_relax_list):
    ...
    rank_graph = rankfig(prefix="Poiseuille", supxlabel='', supylabel=('L2 Relative Error' if file_id == 0 else ''), log=f"graphic\\Poiseuille_0000{file_id}_log.py")
