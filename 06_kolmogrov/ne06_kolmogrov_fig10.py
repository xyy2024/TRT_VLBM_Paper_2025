...
#    Test code for Numerical Experiment Section 06 (Kolmogrov Flow) Fig 10
...
from d2n5_kolmogrov import d2n5_kolmogrov_without_disturbance as model
...
def test(h_list, nu, file_id, average_relax_list):
    ...
    rank_graph = rankfig(prefix="Kolmogrov", supxlabel='', supylabel=('L2 Relative Error' if file_id == 1 else ''), log=f"graphic\\Kolmogrov_0000{file_id}_log.py")
